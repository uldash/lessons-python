...
# Примечание. Имена необходимо вывести на одной строке, разделяя
# символом пробела.
...
users = [{
    ...
    'name': 'Lara',
    'phone': '+7998-676-2532',
    'email': 'g.lara89@gmail.com'
}, {
    'name': 'Alina',
    'phone': '+7948-799-2434',
    'email': 'ali.ch.b@gmail.com'
}, {
    'name': 'Robert',
    'phone': '420-2011',
    'email': ''
    ...
    'name': 'Tim',
    'phone': '242-449-3141',
    'email': 'timm.ggg@yandex.ru'
}]

# result = []
# for dict_item in users:
#     if dict_item['phone'][-1] == '8':
